...
| 本地化建议 | 包装视觉、规格组合、卖点表达、渠道打法、价格带和履约方式怎么贴近目标市场 |
...
最合理的工作流不是“先纯对标”，也不是“只做合规审查”。它会先锁定范围和销售路径，把会直接卡死上架、进口、清关、授权、标签或物流的硬门槛找出来；然后把目标市场对标和本地化建议作为商业判断和落地建议的核心，回答价格、包装、渠道、卖点、信任信号、履约方式和差异化空间。

1. **锁定范围**：原产地、目标市场、销售路径、平台或线下渠道、类目、商品和申请人角色。
2. **拆分销售路径**：跨境电商优先看平台准入、类目审核、Listing 和履约；实体贸易优先看出口、进口、清关、责任方和经销/零售渠道；混合路径两套都看。
3. **做准入风险粗筛**：禁限售、注册备案、标签、宣称、品牌授权、证书、清关、物流和责任方。
4. **规划核验渠道**：监管机构、海关、标准、认证/实验室、品牌/IP、企业注册、物流仓储、用户提供渠道和 agent 主动找到的对标渠道。
5. **做目标市场对标**：在硬门槛可见之后，比较当地商品的价格、规格、包装、渠道、卖点、认证、评论和履约信号。
6. **生成本地化建议**：把对标和准入结果转成包装、标签、文案、渠道、价格、物流和补件的具体修改建议。
7. **交付体检产物**：核心速览卡片 + 详细体检报告；每个重要结论都标注来源层级和是否仍需外部核验。

<details>
<summary>结构化决策状态</summary>

| 状态 | 含义 |
| --- | --- |
| `approve` | 当前证据和核验支持继续推进。 |
| `conditional_approve` | 可以推进，但必须先完成明确的低/中风险修正。 |
| `request_more_info` | 关键材料缺失、无法核验或不覆盖当前范围，暂不能判断。 |
| `reject` | 确认存在严重不合规、禁售、未授权销售或无法修复的无效材料。 |
| `escalate_human` | 疑似造假、制裁/出口管制、敏感身份、法律歧义或权威来源冲突，需要人工升级。 |
| `not_applicable` | 当前审核类型不适用于给定平台、市场、类目或目的。 |
